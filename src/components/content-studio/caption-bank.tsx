  ...
  return (
    <div className="space-y-6">
      ...
      <Modal
        ...
        title={editingId ? "Edit Caption" : "Caption Baru"}
        scrollable
        footer={
          <>
            <button
            ...
            <button type="submit" form="caption-form" disabled={saving} className="btn-primary">
              {saving ? (
                <>
      ...
      >
        <form id="caption-form" onSubmit={handleSave} className="space-y-4">
