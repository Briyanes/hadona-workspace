...
<Modal
          ...
          footer={
            <>
                ...
                <button type="submit" form="brand-kit-form" disabled={saving} className="btn-primary flex items-center gap-1.5 disabled:opacity-50">
        ...
        >
          <form id="brand-kit-form" onSubmit={handleSave}>
