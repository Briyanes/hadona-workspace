...
const METRIC_ALIASES: Record<string, { key: string; unit: "currency" | "number" | "percent" | "ratio" }> = {
  ...
  // 🆕 Sprint 4.8: Tambah 15+ alias outbound_clicks yang sering dipakai di real sheet
  // (advertiser sering pakai "OC", "Klik WA", "Outbound Click", dll)
  "outbound click": { key: "outbound_clicks", unit: "number" },
  "outbound clk": { key: "outbound_clicks", unit: "number" },
  "outbound clk (link)": { key: "outbound_clicks", unit: "number" },
  "outbound": { key: "outbound_clicks", unit: "number" },
  "oc": { key: "outbound_clicks", unit: "number" },
  "oc click": { key: "outbound_clicks", unit: "number" },
  "oc clicks": { key: "outbound_clicks", unit: "number" },
  "klik outbound": { key: "outbound_clicks", unit: "number" },
  "klik wa": { key: "outbound_clicks", unit: "number" },
  "wa klik": { key: "outbound_clicks", unit: "number" },
  "klik link wa": { key: "outbound_clicks", unit: "number" },
  "link wa klik": { key: "outbound_clicks", unit: "number" },
  "click wa": { key: "outbound_clicks", unit: "number" },
  "wa click": { key: "outbound_clicks", unit: "number" },
  "click to wa": { key: "outbound_clicks", unit: "number" },
  "click-to-wa": { key: "outbound_clicks", unit: "number" },
  "ctwa klik": { key: "outbound_clicks", unit: "number" },
  "ctwa click": { key: "outbound_clicks", unit: "number" },
  "outbound klik": { key: "outbound_clicks", unit: "number" },
