-- ============================================
-- HADONA WORKSPACE - MIGRATION v2 FIX
-- Run ini HANYA jika tabel daily_spend belum ada
-- Aman dijalankan ulang (semua IF NOT EXISTS / DROP IF EXISTS)
-- ============================================

-- ============================================
-- 1. CREATE daily_spend TABLE
-- ============================================
...
-- ============================================
-- 3. FIX creative_requests RLS policies
-- DROP dulu, CREATE ulang (untuk hindari "already exists" error)
-- ============================================
...
-- ============================================
-- 4. ENABLE REALTIME for daily_spend
-- ============================================
