-- =============================================
-- Migration v63-fix: Fix ambiguous column reference in regenerate_unpaid_billings()
-- =============================================
...
BEGIN
  ...
  -- Use explicit alias cb. to avoid ambiguous column reference
  FOR b IN
    SELECT cb.* FROM contract_billings cb
...
SELECT 'Migration v63-fix complete — ambiguous column resolved' as status;