/**
 * Run migration-v82.sql against Supabase database
...
async function runMigration() {
  const rawSql = readFileSync('supabase/migration-v82.sql', 'utf8');

  console.log('📋 Running migration-v82.sql...');
  ...
  if (failed > 0) {
    ...
    console.log('   File: supabase/migration-v82.sql');
  }
}
