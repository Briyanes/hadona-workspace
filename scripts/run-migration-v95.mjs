/**
 * Run migration-v95.sql against Supabase database
 * Ads Creative Requests table
 */
...
async function runMigration() {
  const rawSql = readFileSync('supabase/migration-v95.sql', 'utf8');

  console.log('📋 Running migration-v95.sql (ads_creative_requests)...');
