/**
 * Run migration-v85.sql against Supabase database
 * Creates creative_deliverables table for Drive uploads
 */
...
async function runMigration() {
  const rawSql = readFileSync('supabase/migration-v85.sql', 'utf8');

  console.log('📋 Running migration-v85.sql...');
  ...
  if (failed > 0) {
    ...
    console.log('   File: supabase/migration-v85.sql');
  }
}
