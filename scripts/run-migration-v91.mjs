/**
 * Run migration-v91.sql against Supabase database
 * Chat v2: chat_channel_members + chat_channel_calls + RLS + realtime
 */
...
async function runMigration() {
  const rawSql = readFileSync('supabase/migration-v91.sql', 'utf8');

  console.log('📋 Running migration-v91.sql...');
  ...
  if (failed > 0) {
    ...
    console.log('   File: supabase/migration-v91.sql');
  }
}
