/**
 * Run migration-v81.sql against Supabase database
 * Uses PostgREST RPC to execute DDL statements
 */
...
async function runMigration() {
  const rawSql = readFileSync('supabase/migration-v81.sql', 'utf8');

  console.log('📋 Running migration-v81.sql...');
  ...
  if (failed > 0) {
    ...
    console.log('   File: supabase/migration-v81.sql');
  }
}
