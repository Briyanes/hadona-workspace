/**
 * Run migration-v94.sql against Supabase database
 * Ads Content Studio rework: ads_captions + ads_content_clusters tables
 */
...
async function runMigration() {
  const rawSql = readFileSync('supabase/migration-v94.sql', 'utf8');

  console.log('📋 Running migration-v94.sql (Ads Content Studio tables)...');
  ...
  // Split by semicolons (handle dollar-quotes anyway)
  const statements = [];
  let current = '';
