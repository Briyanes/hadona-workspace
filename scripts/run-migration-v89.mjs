/**
 * Run migration-v89.sql against Supabase database
 * Content Plans: task_id linking column + index + Proses Edit reset to Draft
 */
...
async function runMigration() {
  const rawSql = readFileSync('supabase/migration-v89.sql', 'utf8');

  console.log('📋 Running migration-v89.sql...');
  ...
  if (failed > 0) {
    ...
    console.log('   File: supabase/migration-v89.sql');
  }
}
