/**
 * Run migration-v88.sql against Supabase database
 * Content Plans: add tema & thumbnail columns + safety net + RLS fix
 */
...
async function runMigration() {
  const rawSql = readFileSync('supabase/migration-v88.sql', 'utf8');

  console.log('📋 Running migration-v88.sql...');
  ...
  if (failed > 0) {
    ...
    console.log('   File: supabase/migration-v88.sql');
  }
}
